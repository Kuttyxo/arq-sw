...
def crear_clase(datos):
    ...
    try:
        ...
        return {"ok": False, "error": "cupos_max debe ser un número entero"}
...
def actualizar_cupo(datos):
    ...
    try:
        ...
        return {"ok": False, "error": "delta debe ser un número entero"}
    ...
    for c in clases:
        if c["id_clase"] == datos["id_clase"]:
            ...
            if nuevo_cupo > c["cupos_max"]:
                return {"ok": False, "error": "Los cupos no pueden superar el máximo"}
