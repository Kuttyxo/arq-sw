...
# soa_lib.py vive en la raiz del repo; los servicios estan en servicios/.
# Esto permite ejecutar el servicio desde cualquier directorio sin tocar soa_lib.py.
...
def llamar_servicio(nombre_servicio, peticion, timeout=5):
    """Abre una segunda conexion al BUS para consumir otro servicio (patron SOA)."""
    s = None
    try:
        s = connect_to_bus()
